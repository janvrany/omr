 ...
 */
    ...
    TR::TreeEvaluator::directCallEvaluator ,     // TR::icalli		// indirect call returning integer (child1 is addr of function)
    TR::TreeEvaluator::directCallEvaluator ,     // TR::iucalli		// indirect call returning unsigned integer (child1 is addr of function)
    TR::TreeEvaluator::directCallEvaluator ,     // TR::lcalli		// indirect call returning long integer (child1 is addr of function)
    TR::TreeEvaluator::directCallEvaluator ,     // TR::lucalli		// indirect call returning unsigned long integer (child1 is addr of function)
    TR::TreeEvaluator::directCallEvaluator ,     // TR::fcalli		// indirect call returning float (child1 is addr of function)
    TR::TreeEvaluator::directCallEvaluator ,     // TR::dcalli		// indirect call returning double (child1 is addr of function)
    TR::TreeEvaluator::directCallEvaluator ,     // TR::acalli		// indirect call returning reference
    TR::TreeEvaluator::directCallEvaluator ,     // TR::calli		// indirect call returning void (child1 is addr of function)
